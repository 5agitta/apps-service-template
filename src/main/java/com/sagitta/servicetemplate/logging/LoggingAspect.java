package com.sagitta.servicetemplate.logging;
...
public class LoggingAspect {
	...
	@Pointcut ("within(@org.springframework.stereotype.Repository *) " +
			...
			" || within(@com.sagitta.servicetemplate.logging.annotations.LoggingClass *)" +
			" || within(@org.springframework.cloud.openfeign.FeignClient *)")
	public void springBeanPointcut() {
		// Method is empty as this is just a Pointcut, the implementations are in the advices.
	}
	
	@Pointcut("@annotation(com.sagitta.servicetemplate.logging.annotations.NoLogging)")
